...
if(isset($_POST['simpan'])){ 
    ...
    if ($stmt->execute()) { 
        header("Location: tambah.php?status=success&msg=Data berhasil ditambahkan"); 
        exit; 
    } else { 
        header("Location: tambah.php?status=error&msg=Gagal menambahkan data: " . urlencode($stmt->error)); 
        exit; 
    } 
} 
?> 
